...
Original file is located at
    https://colab.research.google.com/drive/1fypVbBHNvsRMx5LD1cvwK33IPL6Vw1Iu
"""
...
#載入我們的py檔
from msg_template import Flex_template,Text_template, Result_flex
...
'''
#1.可選擇地點 > 放出當地區的分布圖
    > https://www.tpisoftware.com/tpu/articleDetails/1136
    > 地址轉成地理編碼(經緯度lat/lng)

#----------------區域-路段字典-------------------
#read region_for_choose.xlsx
#store: region_dict[district] = roads

region_dict = {}
region = ['中正區','大同區','中山區','松山區','大安區','萬華區', '信義區','士林區','北投區','內湖區','南港區','文山區']
#zipcode = [100,103,104,105,106,108,110,111,112,114,115,116]
#Eng_name = []

df = pd.read_excel("region_for_choose.xlsx", sheet_name = 0)
for i in range(len(region)):
    loc = region[i]
    region_dict[loc] = df[loc]
    
#print(region_dict[region[11]])
'''
